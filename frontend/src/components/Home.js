        ...
        return (
          <div className="card">
            ...
            {/* <div className="card-header">
              ...
              <h5>
              <Link to={`/profile/${posts.postedBy._id}`} style={{ textDecoration: 'none'  , color:'black'}}>
                  {posts.postedBy.name}
                </Link>
              </h5>
            </div> */}
...
<div className="card-header">
  ...
  <h5>
    <Link to={`/profile/${posts.postedBy ? posts.postedBy._id : ''}`} style={{ textDecoration: 'none', color: 'black' }}>
      {posts.postedBy ? posts.postedBy.name : 'Unknown'}
            ...
            <div className="card-content">
              ...
              <p style={{fontWeight:'bold'}}>{posts.likes.length} Likes</p>
              <p><span style={{color:'rgba(var(--f52,142,142,142),1)' , fontWeight:'bold'}}>caption</span> {posts.body}</p>
              <p style={{ fontWeight: "bold", cursor: 'pointer' , color:'rgb(9, 7, 74)'}} onClick={() => {
                toggleComment(posts);
              }}>View all comments</p>
            </div>
